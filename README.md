...
If you want to run multiple omnia's feed instances then you have to change the name of the systemd files which are generated by ./setup/run_feed.sh or ./setup/run_it_relay.sh and change the config files and run it again.
